...
export const SelectList = SelectTemplate.bind({});

const ItemListTemplate = args => (
  <div style={{ height: '300px' }}>
    <ItemListInput isMultiSelect={args.isMultiSelect} />
  </div>
);
...
const DragAndDropTemplate = args => <DraggableLists {...args} />;
export const DragAndDropLists = DragAndDropTemplate.bind({});
