...
import { ViewportData, IndexRange, StorageSnapshot, StorageTableViewport, FilterConfig, SortConfig, ViewportUpdateCallback, StorageListenerRemover } from '@deephaven/storage';
...
export class MockFileStorageTable implements FileStorageTable {
  ...
  async getSnapshot(sortedRanges: IndexRange[]): Promise<StorageSnapshot<FileStorageItem>> {
    throw new Error('Method not implemented.');
  }
  async setViewport(viewport: StorageTableViewport) {
