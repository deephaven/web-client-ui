...
If your DHC address is different from the default `http://localhost:10000`, edit `.env.development.local` in each package to contain the following pointing to your local DHC. These are needed for the session websocket and for things like notebooks to be proxied correctly by Vite.
